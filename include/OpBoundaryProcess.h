...
//
//
// $Id: OpBoundaryProcess.hh 96023 2016-03-08 08:25:42Z gcosmo $
//
// 
////////////////////////////////////////////////////////////////////////
...
#ifndef OPBOUNDARYPROCESS_H
#define OPBOUNDARYPROCESS_H
...
enum OpBoundaryProcessStatus {  Undefined,
...
public:
        ...
        OpBoundaryProcess(const G4String& processName = "OpBoundary",
                                     G4ProcessType type = fOptical);
	~OpBoundaryProcess();

private:

        OpBoundaryProcess(const OpBoundaryProcess &right);
...
public:
	...
	G4VParticleChange* PostStepDoIt(const G4Track& aTrack,
        ...
        OpBoundaryProcessStatus GetStatus() const;
...
private:
	...
	OpBoundaryProcessStatus theStatus;
...
inline
G4bool OpBoundaryProcess::G4BooleanRand(const G4double prob) const
{
...
inline
G4bool OpBoundaryProcess::IsApplicable(const G4ParticleDefinition& 
					               aParticleType)
{
...
inline
OpBoundaryProcessStatus OpBoundaryProcess::GetStatus() const
{
   return theStatus;
}

inline
void OpBoundaryProcess::SetInvokeSD(G4bool flag)
{
  fInvokeSD = flag;
}

inline
void OpBoundaryProcess::ChooseReflection()
{
...
inline
void OpBoundaryProcess::DoAbsorption()
{
...
inline
void OpBoundaryProcess::DoReflection()
{
