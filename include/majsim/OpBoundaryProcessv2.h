...
#ifndef OPBOUNDARYPROCESSV2_H
#define OPBOUNDARYPROCESSV2_H
...
// Class Description - End:
    ...
    enum OpBoundaryProcessv2ProcessStatus {
        Undefined,
    ...
    class OpBoundaryProcessv2: public G4VDiscreteProcess {

    public:

        explicit OpBoundaryProcessv2(const G4String &processName = "OpBoundary",
                                     G4ProcessType type = fOptical);

        virtual ~OpBoundaryProcessv2();
        ...
        virtual OpBoundaryProcessv2ProcessStatus GetStatus() const;
    ...
    private:
        ...
        OpBoundaryProcessv2(const OpBoundaryProcessv2 &right) = delete;

        OpBoundaryProcessv2 &operator=(const OpBoundaryProcessv2 &right) = delete;
        /**
       ...
       */
        ...
        OpBoundaryProcessv2ProcessStatus theStatus;
...
////////////////////
    ...
    inline
    G4bool OpBoundaryProcessv2::G4BooleanRand(const G4double prob) const {
        /* Returns a random boolean variable with the specified probability */
        return (G4UniformRand() < prob);
    }

    inline
    G4bool OpBoundaryProcessv2::IsApplicable(const G4ParticleDefinition &
    aParticleType) {
        return (&aParticleType == G4OpticalPhoton::OpticalPhoton());
    }

    inline
    OpBoundaryProcessv2ProcessStatus OpBoundaryProcessv2::GetStatus() const {
        return theStatus;
    }

    inline
    void OpBoundaryProcessv2::SetInvokeSD(G4bool flag) {
        fInvokeSD = flag;
    }

    inline
    void OpBoundaryProcessv2::ChooseReflection() {
    ...
    inline
    void OpBoundaryProcessv2::DoAbsorption() {
    ...
    inline
    void OpBoundaryProcessv2::DoReflection() {
...
#endif //MAJORANA_OPBOUNDARYPROCESSV2_H
