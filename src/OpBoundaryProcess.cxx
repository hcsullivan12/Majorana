...
// OpBoundaryProcess::operator=(const OpBoundaryProcess &right)
// {
// }
...
// OpBoundaryProcess::OpBoundaryProcess(const OpBoundaryProcess &right)
// {
// }
...
OpBoundaryProcess::~OpBoundaryProcess(){}
...
bool OpBoundaryProcess::CheckDetection(const G4Track& theTrack, const G4Step& theStep)
{
  ...
  majorana::PrimaryGeneratorAction* genAction = g4Helper->GetActionInitialization()->GetGeneratorAction();
      ...
      (mppcZ-mppcHalfL) <= z && z <= (mppcZ+mppcHalfL) ) 
  {
    ...
    for (const auto& pos : mppcPositions)
    {
           ...
           (thisTheta-delT) <= theta && theta <= (thisTheta+delT) )
      {
        ...
        // Create the photon
        majorana::Photon thePhoton(photonVertex);
        // Add to table 
        majorana::OpDetPhotonTable* thePhotonTable = majorana::OpDetPhotonTable::Instance();
...
G4VParticleChange*
OpBoundaryProcess::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
{
        theStatus = Undefined;
	...
	OldPolarization   = aParticle->GetPolarization();
      ...
      //****************************************
        ...
        else 
        {
          ...
          ed << " OpBoundaryProcess/PostStepDoIt(): "
                 << " The Navigator reports that it returned an invalid normal"
                 << G4endl;
          G4Exception("OpBoundaryProcess::PostStepDoIt", "OpBoun01",
        ...
        if (OldMomentum * theGlobalNormal > 0.0) {
           ...
           ed << G4endl;
           G4Exception("OpBoundaryProcess::PostStepDoIt", "OpBoun02",
...
G4ThreeVector
OpBoundaryProcess::GetFacetNormal(const G4ThreeVector& Momentum,
...
void OpBoundaryProcess::DielectricLUT()
{
        ...
        theStatus = OpBoundaryProcessStatus(G4int(theFinish) + 
...
//                   << std::floor(theTransmittance/perCent) << "%" << G4endl;
           ...
           G4ExceptionDescription ed;
           ed << " OpBoundaryProcess/DielectricDichroic(): "
              << " The dichroic surface has no G4Physics2DVector"
              << G4endl;
           G4Exception("OpBoundaryProcess::DielectricDichroic", "OpBoun03",
                       FatalException,ed,
...
// ---------------
//
G4double OpBoundaryProcess::GetMeanFreePath(const G4Track& ,
                                              G4double ,
