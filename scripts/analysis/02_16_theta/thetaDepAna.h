...
// Sat Feb 16 14:41:50 2019 by ROOT version 6.14/00
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/production/25_thetaDep.root
//////////////////////////////////////////////////////////

#ifndef thetaDepAna_h
#define thetaDepAna_h
...
#ifdef thetaDepAna_cxx
thetaDepAna::thetaDepAna(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/production/25_thetaDep.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/production/25_thetaDep.root");
      }
...
thetaDepAna::~thetaDepAna()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t thetaDepAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t thetaDepAna::LoadTree(Long64_t entry)
{
...
void thetaDepAna::Init(TTree *tree)
{
...
void thetaDepAna::Show(Long64_t entry)
{
...
Int_t thetaDepAna::Cut(Long64_t entry)
{
