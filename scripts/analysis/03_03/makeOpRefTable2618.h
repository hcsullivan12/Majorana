...
// Sun Mar  3 10:51:15 2019 by ROOT version 6.14/04
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/production/2618Pixels_v1/03_02_2618Pixels.root
//////////////////////////////////////////////////////////

#ifndef makeOpRefTable2618_h
#define makeOpRefTable2618_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           event;
   Int_t           nPixels;
   Double_t        pixelX[2617];   //[nPixels]
   Double_t        pixelY[2617];   //[nPixels]
   Int_t           nMPPCs;
   Double_t        diskRadius;
   Int_t           nPrimaries;
   ...
   makeOpRefTable2618(TTree *tree=0);
   virtual ~makeOpRefTable2618();
...
#ifdef makeOpRefTable2618_cxx
makeOpRefTable2618::makeOpRefTable2618(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/production/2618Pixels_v1/03_02_2618Pixels.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/production/2618Pixels_v1/03_02_2618Pixels.root");
      }
...
makeOpRefTable2618::~makeOpRefTable2618()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t makeOpRefTable2618::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t makeOpRefTable2618::LoadTree(Long64_t entry)
{
...
void makeOpRefTable2618::Init(TTree *tree)
{
...
Bool_t makeOpRefTable2618::Notify()
{
...
void makeOpRefTable2618::Show(Long64_t entry)
{
...
Int_t makeOpRefTable2618::Cut(Long64_t entry)
{
...
#endif // #ifdef makeOpRefTable2618_cxx
