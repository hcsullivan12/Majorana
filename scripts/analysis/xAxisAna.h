...
// Tue Jan  8 19:57:17 2019 by ROOT version 6.14/00
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/output/simulateOutputXaxis.root
//////////////////////////////////////////////////////////
...
#ifdef xAxisAna_cxx
xAxisAna::xAxisAna(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/output/simulateOutputXaxis.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/output/simulateOutputXaxis.root");
      }
...
Int_t xAxisAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t xAxisAna::LoadTree(Long64_t entry)
{
...
void xAxisAna::Show(Long64_t entry)
{
...
Int_t xAxisAna::Cut(Long64_t entry)
{
