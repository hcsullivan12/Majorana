#define xAxisVoxelsAna_cxx
#include "xAxisVoxelsAna.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
std::vector<float> vec1(289, 0);
std::vector<float> vec2(289, 0);
...
void xAxisVoxelsAna::Loop()
{
  ...
  for (Long64_t jentry=0; jentry<nentries;jentry++) 
  {
    ...
    vec1[voxelID-1] = mppcToSourceR[1-1];
