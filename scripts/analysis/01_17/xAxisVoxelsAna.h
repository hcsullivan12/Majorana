...
// Thu Jan 17 22:35:47 2019 by ROOT version 6.14/00
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/production/voxelization1mmXaxis.root
//////////////////////////////////////////////////////////

#ifndef xAxisVoxelsAna_h
#define xAxisVoxelsAna_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   xAxisVoxelsAna(TTree *tree=0);
   virtual ~xAxisVoxelsAna();
...
#ifdef xAxisVoxelsAna_cxx
xAxisVoxelsAna::xAxisVoxelsAna(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/production/voxelization1mmXaxis.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/production/voxelization1mmXaxis.root");
      }
...
xAxisVoxelsAna::~xAxisVoxelsAna()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t xAxisVoxelsAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t xAxisVoxelsAna::LoadTree(Long64_t entry)
{
...
void xAxisVoxelsAna::Init(TTree *tree)
{
...
void xAxisVoxelsAna::Show(Long64_t entry)
{
...
Int_t xAxisVoxelsAna::Cut(Long64_t entry)
{
...
#endif // #ifdef xAxisVoxelsAna_cxx
