...
// Fri Feb 15 21:21:29 2019 by ROOT version 6.14/00
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/production/25_xAxis_1mm.root
//////////////////////////////////////////////////////////

#ifndef xAxis1mmAna_h
#define xAxis1mmAna_h
...
#ifdef xAxis1mmAna_cxx
xAxis1mmAna::xAxis1mmAna(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/production/25_xAxis_1mm.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/production/25_xAxis_1mm.root");
      }
...
xAxis1mmAna::~xAxis1mmAna()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t xAxis1mmAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t xAxis1mmAna::LoadTree(Long64_t entry)
{
...
void xAxis1mmAna::Init(TTree *tree)
{
...
void xAxis1mmAna::Show(Long64_t entry)
{
...
Int_t xAxis1mmAna::Cut(Long64_t entry)
{
