#define thetaDepWithDiskCorrectionAna_cxx
#include "thetaDepWithDiskCorrectionAna.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
...
//*******************************************
void thetaDepWithDiskCorrectionAna::Loop()
{
  // Prepare map!
...
void Ana()
{
 ...
 /*
  ...
  TF1* cosL = new TF1("cosL", "72*TMath::Cos(x*TMath::Pi()/180)", 0, 70);
  cosL->Draw("same");
  cosL->SetLineWidth(4);
  cosL->SetLineColor(1);
  */
