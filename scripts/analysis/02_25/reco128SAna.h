...
// Mon Feb 25 13:35:22 2019 by ROOT version 6.14/04
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/production/665p_128s_1000e.root
//////////////////////////////////////////////////////////

#ifndef reco128SAna_h
#define reco128SAna_h
...
#ifdef reco128SAna_cxx
reco128SAna::reco128SAna(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/production/665p_128s_1000e.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/production/665p_128s_1000e.root");
      }
...
reco128SAna::~reco128SAna()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t reco128SAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t reco128SAna::LoadTree(Long64_t entry)
{
...
void reco128SAna::Init(TTree *tree)
{
...
void reco128SAna::Show(Long64_t entry)
{
...
Int_t reco128SAna::Cut(Long64_t entry)
{
