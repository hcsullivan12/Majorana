...
// Fri Mar  1 08:33:15 2019 by ROOT version 6.14/04
...
#ifdef reco16SAna_cxx
reco16SAna::reco16SAna(TTree *tree) : fChain(0) 
{
...
reco16SAna::~reco16SAna()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t reco16SAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t reco16SAna::LoadTree(Long64_t entry)
{
...
void reco16SAna::Init(TTree *tree)
{
...
void reco16SAna::Show(Long64_t entry)
{
...
Int_t reco16SAna::Cut(Long64_t entry)
{
