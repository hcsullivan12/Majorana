...
// Mon Feb 25 09:16:40 2019 by ROOT version 6.14/04
...
#ifdef recoAna_cxx
recoAna::recoAna(TTree *tree) : fChain(0) 
{
...
Int_t recoAna::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t recoAna::LoadTree(Long64_t entry)
{
...
void recoAna::Show(Long64_t entry)
{
...
Int_t recoAna::Cut(Long64_t entry)
{
