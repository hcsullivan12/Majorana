...
// Thu Feb 14 22:46:54 2019 by ROOT version 6.14/00
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/production/1000_center.root
//////////////////////////////////////////////////////////

#ifndef Center1000Ana_h
#define Center1000Ana_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Center1000Ana(TTree *tree=0);
   virtual ~Center1000Ana();
...
#ifdef Center1000Ana_cxx
Center1000Ana::Center1000Ana(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/hunter/projects/Majorana/production/1000_center.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/hunter/projects/Majorana/production/1000_center.root");
      }
...
Center1000Ana::~Center1000Ana()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Center1000Ana::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Center1000Ana::LoadTree(Long64_t entry)
{
...
void Center1000Ana::Init(TTree *tree)
{
...
void Center1000Ana::Show(Long64_t entry)
{
...
Int_t Center1000Ana::Cut(Long64_t entry)
{
