...
// Fri Jan 11 12:54:04 2019 by ROOT version 6.14/00
// from TTree anatree/analysis tree
// found on file: /home/hunter/projects/Majorana/output/simulateOutput.root
//////////////////////////////////////////////////////////

#ifndef absorptionTestXAxis_h
#define absorptionTestXAxis_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   absorptionTestXAxis(TTree *tree=0);
   virtual ~absorptionTestXAxis();
...
#ifdef absorptionTestXAxis_cxx
absorptionTestXAxis::absorptionTestXAxis(TTree *tree) : fChain(0) 
{
...
absorptionTestXAxis::~absorptionTestXAxis()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t absorptionTestXAxis::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t absorptionTestXAxis::LoadTree(Long64_t entry)
{
...
void absorptionTestXAxis::Init(TTree *tree)
{
...
Bool_t absorptionTestXAxis::Notify()
{
...
void absorptionTestXAxis::Show(Long64_t entry)
{
...
Int_t absorptionTestXAxis::Cut(Long64_t entry)
{
...
#endif // #ifdef absorptionTestXAxis_cxx
