...
const unsigned ledTriggers = 15000;
...
void Ana();
void Update(std::vector<unsigned> );

/**********************/
void doAnalyze(std::string inputpath, std::string outputpath, std::string filename)
{
...
/**********************/
void Update(std::vector<unsigned> theCounts)
{
  // TEMPORARY FIX....
