...
std::string pixelizationPath = "/home/hunter/projects/Majorana/production/665Pixels_v2/pixelization.txt";
class Pixel;
...
unsigned nEvents(10);
Int_t factor(3); // used to switch nSiPMs, nSiPMs --> nSiPMs / 2^(factor)
